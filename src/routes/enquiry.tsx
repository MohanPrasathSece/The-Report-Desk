...
import { AlertCircle, CheckCircle, ArrowRight, Shield, Lock, Activity, Landmark, Sparkles, KeyRound, Fingerprint, Radar, BadgeCheck, Info, Menu, X } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#0b0a10] text-white font-sans selection:bg-purple-600 selection:text-white antialiased overflow-x-clip relative" style={{ fontFamily: "'Plus Jakarta Sans', 'Outfit', sans-serif" }}>
      ...
      <header className="fixed top-4 md:top-6 left-0 right-0 z-50 flex justify-center px-4">
        <div className={`w-full max-w-4xl rounded-2xl border backdrop-blur-xl px-4 sm:px-6 py-2.5 flex items-center justify-between transition-all duration-300 ${
      ...
      <main className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 pt-28 md:pt-48 pb-20 space-y-24 md:space-y-32">
        ...
        <section id="hero" className="text-center max-w-3xl mx-auto space-y-6 md:space-y-8">
